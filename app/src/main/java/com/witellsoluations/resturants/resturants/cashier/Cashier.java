...
import com.witellsoluations.resturants.resturants.waiter.WaiterPagerAdapter;
import com.witellsoluations.resturants.resturants.waiter.tabs.OrderTab;

public class Cashier extends AppCompatActivity implements Tab1.OnFragmentInteractionListener, CashierOrderTab.OnFragmentInteractionListener, Tab3.OnFragmentInteractionListener{
...
//        tabLayout.addTab(tabLayout.newTab().setText("Re-Order"));
    ...
    void viewPager() {
        ...
        CashierPagerAdapter userPagerAdapter = new CashierPagerAdapter(getSupportFragmentManager(),tabLayout.getTabCount());
